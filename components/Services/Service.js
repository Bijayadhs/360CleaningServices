const Service = (props) => {
    ...
    return (
        <div className='bg-indigo-300 my-2 mr-2 h-36 md:h-44 md:first:mt-8 md:last:mt-16  rounded-md shadow-md hover:shadow-xl hover:scale-110 cursor-pointer p-4 transform first:rotate-3 last:-rotate-3'>
